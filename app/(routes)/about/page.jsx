  ...
  return (
    <main className="max-w-screen-xl h-screen py-14 mx-auto flex flex-col items-center sm:justify-center gap-2 mt-14 sm:my-0">
      ...
      <p className="text-gray-600 antialiased text-xl font-light max-w-xl tracking-wider leading-8 dark:text-slate-100">
        I am a fourth-year computer engineering student at Balıkesir University,
        driven by an investigative mindset and a strong commitment to continuous
        improvement. While I am still in the early stages of mastering the
        English language, I am dedicated to the learning process. My current
        focus lies in back-end development, where I utilize technologies such as
        C#, .NET Core, JavaScript and SQL Server. I predominantly craft my
